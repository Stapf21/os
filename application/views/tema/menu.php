...
<nav id="sidebar">
    <div id="newlog">
        <div class="icon2">
            <!-- Removido: <img src="<?php echo base_url() ?>assets/img/logo4.png"> -->
        </div>
        <div class="title1">
            <?= $configuration['app_theme'] == 'white' || $configuration['app_theme'] == 'whitegreen' ? '<img src="' . base_url() . 'assets/img/logo2.png">' : '<img src="' . base_url() . 'assets/img/logo3.png">'; ?>
        </div>
    </div>
            ...
            <ul class="menu-links" style="position: relative;">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) { ?>
                    <li class="<?php if (isset($menuVendas)) {
                        ...
                        <a class="tip-bottom" title="" href="<?= site_url('vendas') ?>"><i class='bx bx-cart-alt iconX'></i>
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vOrcamento')) { ?>
                    <li class="<?php if (isset($menuOrcamentos)) {
                        echo 'active';
                    }; ?>">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vPmoc')) { ?>
                    <li class="<?php if (isset($menuPmoc)) {
                        echo 'active';
                    }; ?>">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
                    ...
                    <li class="<?php if (isset($menuPnl)) {
                        ...
                        <a class="tip-bottom" title="" href="<?= site_url('pnl') ?>"><i class='bx bx-line-chart iconX'></i>
                            <span class="title">P&amp;L por Cliente</span>
                            <span class="title-tooltip">P&amp;L</span>
                        </a>
                    </li>
                <?php } ?>
