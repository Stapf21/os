...
class Clientes extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        $this->data['grupos_empresariais'] = $this->clientes_model->getGruposEmpresariais();
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = [
                ...
                'grupo_empresarial' => set_value('grupo_empresarial'),
                'tipo_consolidacao_pnl' => set_value('tipo_consolidacao_pnl') ?: 'consolidado',
            ];
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            if ($senha != null) {
                ...
                $data = [
                    ...
                    'tipo_consolidacao_pnl' => $this->input->post('tipo_consolidacao_pnl') ?: 'consolidado',
                ];
            } else {
                $data = [
                    'nomeCliente' => $this->input->post('nomeCliente'),
