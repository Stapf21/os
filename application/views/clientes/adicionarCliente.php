                ...
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="grupo_empresarial" list="grupos_empresariais" type="text" name="grupo_empresarial" value="<?php echo set_value('grupo_empresarial'); ?>" placeholder="Ex.: Grupo Zelares" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select id="tipo_consolidacao_pnl" name="tipo_consolidacao_pnl">
                                    <option value="consolidado" <?php echo set_value('tipo_consolidacao_pnl') === 'consolidado' ? 'selected' : ''; ?>>Consolidado</option>
                                    <option value="detalhado" <?php echo set_value('tipo_consolidacao_pnl') === 'detalhado' ? 'selected' : ''; ?>>Detalhado por unidade</option>
                                </select>
                            </div>
                        </div>
                    </div>
