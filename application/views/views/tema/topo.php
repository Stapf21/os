...
<head>
  <title><?= $configuration['app_name'] ?: 'Sistema' ?></title>
  <meta charset="UTF-8" />
  ...
  <!-- TinyMCE -->
  <script src="https://cdn.tiny.cloud/1/8d32v8wkqz67ylwdnal5mkwd6w377cyal2aiwldjr4tw3o9w/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
      ...
      <ul class="nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?= site_url('relatorios/pmoc') ?>">PMOC</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?= site_url('configuracoes/atualizacoes') ?>">Atualizacoes</a></li>
