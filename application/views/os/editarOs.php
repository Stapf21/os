                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab5">
                            <div class="span12" style="padding: 1%; margin-left: 0">
                                <div class="span12" style="padding: 1%; margin-left: 0">
                                    <div class="span6">
                                        <label for="anexos">Anexos da OS</label>
                                        <input type="file" class="span12" name="userfile[]" multiple="multiple" accept="image/*" />
                                        <small>Formatos aceitos: jpg, jpeg, png. Tamanho máximo: 2MB</small>
                                    </div>
                                    <?php if ($anexos != null) { ?>
                                        <div class="span6">
                                            <label for="anexos">Anexos Existentes</label>
                                            <div class="anexos-existentes">
                                                <?php foreach ($anexos as $anexo) : ?>
                                                    <div class="anexo-item">
                                                        <img src="<?= base_url('assets/anexos/' . $anexo->anexo); ?>" alt="Anexo" class="anexo-thumb" />
                                                        <a href="#modal-excluir-anexo" role="button" data-toggle="modal" anexo="<?= $anexo->idAnexos; ?>" class="btn-excluir-anexo">
