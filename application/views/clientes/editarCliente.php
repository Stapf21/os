            ...
            <form action="<?php echo current_url(); ?>" id="formCliente" method="post" class="form-horizontal">
                <div class="widget-content nopadding tab-content">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label for="grupo_empresarial" class="control-label">Grupo Empresarial</label>
                            <div class="controls">
                                <input id="grupo_empresarial" list="grupos_empresariais" type="text" name="grupo_empresarial" value="<?php echo $result->grupo_empresarial ?? ''; ?>" placeholder="Ex.: Grupo Zelares" />
                                <datalist id="grupos_empresariais">
                                    <?php foreach (($grupos_empresariais ?? []) as $grupo) { ?>
                                        <option value="<?php echo htmlspecialchars($grupo->grupo_empresarial); ?>">
                                    <?php } ?>
                                </datalist>
                            </div>
                        </div>
                        <div class="control-group">
                            <label for="tipo_consolidacao_pnl" class="control-label">Visão P&amp;L</label>
                            <div class="controls">
                                <select id="tipo_consolidacao_pnl" name="tipo_consolidacao_pnl">
                                    <option value="consolidado" <?php echo ($result->tipo_consolidacao_pnl ?? 'consolidado') === 'consolidado' ? 'selected' : ''; ?>>Consolidado</option>
                                    <option value="detalhado" <?php echo ($result->tipo_consolidacao_pnl ?? '') === 'detalhado' ? 'selected' : ''; ?>>Detalhado por unidade</option>
                                </select>
                            </div>
                        </div>
                    </div>
