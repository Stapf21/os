...
class Clientes_model extends CI_Model
{
    ...
    public function getGruposEmpresariais()
    {
        $this->db->distinct();
        $this->db->select('grupo_empresarial');
        $this->db->from('clientes');
        $this->db->where('grupo_empresarial IS NOT NULL', null, false);
        $this->db->where('grupo_empresarial !=', '');
        $this->db->order_by('grupo_empresarial', 'asc');
