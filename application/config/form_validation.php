...
$config = [
    ...
    'adicionar_produto_orcamento' => [
        ...
        [
            'field' => 'idOrcamentoProduto',
            'label' => 'idOrcamentoProduto',
            'rules' => 'trim|required|numeric',
        ],
    ],
    'adicionar_servico_orcamento' => [
        [
            'field' => 'idServico',
            'label' => 'idServico',
            'rules' => 'trim|required|numeric',
        ...
        [
            'field' => 'idOrcamentoServico',
            'label' => 'idOrcamentoServico',
            'rules' => 'trim|required|numeric',
        ],
    ],
    'cobrancas' => [
