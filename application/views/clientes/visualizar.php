<div class="widget-box">
    <div class="widget-title" style="margin: 0;font-size: 1.1em">
        <ul class="nav nav-tabs">
            ...
            <li><a data-toggle="tab" href="#tab4">P&amp;L</a></li>
        </ul>
    </div>
    <div class="widget-content tab-content">
        ...
        <div id="tab4" class="tab-pane" style="min-height: 300px">
            <div class="widget-box" style="margin-top: 12px;">
                <div class="widget-title">
                    <h5>Painel Financeiro por Cliente</h5>
                </div>
                <div class="widget-content" style="padding: 20px;">
                    <table class="table table-bordered" style="border: 1px solid #ddd">
                        <tbody>
                            <tr>
                                <td style="text-align: right; width: 30%"><strong>Grupo Empresarial</strong></td>
                                <td><?php echo !empty($result->grupo_empresarial) ? htmlspecialchars($result->grupo_empresarial) : 'Nao informado'; ?></td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><strong>Visao P&amp;L</strong></td>
                                <td><?php echo !empty($result->tipo_consolidacao_pnl) ? htmlspecialchars(ucfirst($result->tipo_consolidacao_pnl)) : 'Consolidado'; ?></td>
                            </tr>
                        </tbody>
                    </table>
                    <div style="margin-top: 16px; display:flex; gap: 10px; flex-wrap: wrap;">
                        <a href="<?php echo base_url('pnl/cliente/' . $result->idClientes); ?>" class="button btn btn-mini btn-success">
                            <span class="button__icon"><i class="bx bx-line-chart"></i></span>
                            <span class="button__text2">Abrir P&amp;L do Cliente</span>
                        </a>
                        <a href="<?php echo base_url('pnl'); ?>" class="button btn btn-mini btn-info">
                            <span class="button__icon"><i class="bx bx-bar-chart-alt-2"></i></span>
                            <span class="button__text2">Painel Consolidado</span>
                        </a>
                    </div>
                </div>
            </div>
