        ...
        <div id="tab1" class="tab-pane active" style="min-height: 300px">
            <div class="accordion" id="collapse-group">
                ...
                <div class="accordion-group widget-box">
                    <div class="accordion-heading">
                        <div class="widget-title">
                            <a data-parent="#collapse-group" href="#collapseGFourOrc" data-toggle="collapse">
                    ...
                    <div class="collapse accordion-body" id="collapseGFourOrc">
                        <div class="widget-content">
                        <table class="table table-bordered">
                            <tr>
                                <td colspan="4"></td>
                            ...
                            <tr>
                                <td>
                                    <label>
                                            ...
                                            <span class="lbl"> Visualizar Orcamento</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Adicionar Orcamento</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Editar Orcamento</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Excluir Orcamento</span>
                                        </label>
                                    </td>
                                </tr>
                            </table>
