...
class Produtos extends MY_Controller
{
    ...
    public function adicionar()
    {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $precoCompra = $this->normalizeDecimal($this->input->post('precoCompra'));
            $precoVenda = $this->normalizeDecimal($this->input->post('precoVenda'));
            $data = [
                ...
                'estoque' => $this->normalizeDecimal(set_value('estoque')),
                'estoqueMinimo' => $this->normalizeDecimal(set_value('estoqueMinimo')),
    ...
    public function editar()
    {
        ...
        if ($this->form_validation->run('produtos') == false) {
            ...
            $data = [
                ...
                'precoCompra' => $precoCompra,
                'precoVenda' => $precoVenda,
                'estoque' => $this->normalizeDecimal($this->input->post('estoque')),
                'estoqueMinimo' => $this->normalizeDecimal($this->input->post('estoqueMinimo')),
                'saida' => set_value('saida'),
                'entrada' => set_value('entrada'),
            ];
    ...
    public function atualizar_estoque()
    {
        ...
        $novoEstoque = $this->normalizeDecimal($this->input->post('estoque'));
        $estoqueAtual = $this->normalizeDecimal($this->input->post('estoqueAtual'));
