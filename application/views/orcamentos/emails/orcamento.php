    ...
    <div class="invoice-box">
        <table cellpadding="0" cellspacing="0">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="text-align: right">
                                Orcamento #: <?= $result->idOrcamento ?><br>
                                Data criacao: <?= $dataCriacao ?> <br>
                                Validade: <?= $validade ?>
                            </td>
                        </tr>
                    </table>
            ...
            <?php if (!empty($result->condicoes)) { ?>
                ...
                <tr>
                    <td class="justify" colspan="4">
                        <?= htmlspecialchars_decode($result->condicoes) ?>
                    </td>
                </tr>
            <?php } ?>
            ...
            <?php if ($servicos) { ?>
                ...
                <tr class="item">
                    <td colspan="3"></td>
                    <td style="text-align: center"><strong>Total em Servicos: R$ <?= number_format($totalServicos, 2, ',', '.'); ?></strong></td>
                </tr>
            <?php } ?>
            ...
            <tr class="heading">
                ...
                <td style="text-align: center">
                    <strong>Total: R$ <?= number_format($totalProdutos + $totalServicos, 2, ',', '.') ?></strong>
                </td>
            </tr>
            <?php if ($result->desconto != 0 && $result->valor_desconto != 0) { ?>
                <tr class="heading">
                    <td colspan="3"></td>
                    <td style="text-align: center">
                        <strong>Desconto: R$ <?= number_format($result->valor_desconto - ($totalProdutos + $totalServicos), 2, ',', '.') ?></strong>
                    </td>
                </tr>
                <tr class="heading">
                    <td colspan="3"></td>
